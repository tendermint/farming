...
- Reserves the amount of coins to the staking reserve account for each staking coin denom `return address.Module(ModuleName, []byte("StakingReserveAcc|"+stakingCoinDenom))` 
