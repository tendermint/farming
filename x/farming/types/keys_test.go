...
func (s *keysTestSuite) TestGetPlansByFarmerIndexKey() {
	...
	s.Require().Equal([]byte{0x12, 0x14, 0xd3, 0x7a, 0x85, 0xec, 0x75, 0xf, 0x3, 0xaa, 0xe5,
		0x36, 0xcf, 0x1b, 0xb7, 0x59, 0xb7, 0xbc, 0xbd, 0x5c, 0xfe, 0x3d}, types.GetPlansByFarmerIndexKey(farmer0))
	s.Require().Equal([]byte{0x12, 0x14, 0x15, 0x1, 0x20, 0x25, 0x5a, 0x5d, 0xe8, 0x6b, 0xa1,
		0xed, 0xfb, 0x6f, 0x45, 0x48, 0xcb, 0xfb, 0x6f, 0x28, 0x66, 0xf3}, types.GetPlansByFarmerIndexKey(farmer1))
	s.Require().Equal([]byte{0x12, 0x14, 0xdf, 0xb0, 0x6d, 0xbf, 0xc6, 0x9a, 0xcd, 0xf5, 0x7b,
		0xb, 0xe7, 0x69, 0x75, 0x50, 0x9e, 0x69, 0x54, 0xa6, 0x1e, 0xe2}, types.GetPlansByFarmerIndexKey(farmer2))
	s.Require().Equal([]byte{0x12, 0x14, 0x98, 0x94, 0x3f, 0x57, 0x25, 0xab, 0x66, 0xef, 0x46,
		0x63, 0x4a, 0xfe, 0xeb, 0x8, 0xc0, 0x4a, 0x53, 0x25, 0x2c, 0x9f}, types.GetPlansByFarmerIndexKey(farmer3))
}
...
func (s *keysTestSuite) TestGetPlanByFarmerAddrIndexKey() {
	testCases := []struct {
	...
	}{
		{
			...
			1,
			[]byte{0x12, 0x14, 0xd3, 0x7a, 0x85, 0xec, 0x75, 0xf, 0x3, 0xaa, 0xe5, 0x36, 0xcf, 0x1b, 0xb7,
				0x59, 0xb7, 0xbc, 0xbd, 0x5c, 0xfe, 0x3d, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x1},
		},
		{
			sdk.AccAddress(crypto.AddressHash([]byte("farmer2"))),
			2,
			[]byte{0x12, 0x14, 0x15, 0x1, 0x20, 0x25, 0x5a, 0x5d, 0xe8, 0x6b, 0xa1, 0xed, 0xfb, 0x6f, 0x45,
				0x48, 0xcb, 0xfb, 0x6f, 0x28, 0x66, 0xf3, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x2},
		},
		{
			sdk.AccAddress(crypto.AddressHash([]byte("farmer3"))),
			2,
			[]byte{0x12, 0x14, 0xdf, 0xb0, 0x6d, 0xbf, 0xc6, 0x9a, 0xcd, 0xf5, 0x7b, 0xb, 0xe7, 0x69, 0x75,
				0x50, 0x9e, 0x69, 0x54, 0xa6, 0x1e, 0xe2, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x2},
		},
	}
