...
type MsgCreateRatioPlan struct {
	...
	RewardDenoms []string `protobuf:"bytes,7,rep,name=reward_denoms,json=rewardDenoms,proto3" json:"reward_denoms,omitempty" yaml:"reward_denoms"`
}
...
func (*MsgAdvanceEpoch) Descriptor() ([]byte, []int) {
	return fileDescriptor_a33d9a3ff13f514a, []int{12}
}
...
func (*MsgAdvanceEpochResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_a33d9a3ff13f514a, []int{13}
}
...
func init() {
	...
	proto.RegisterType((*MsgRemovePlan)(nil), "cosmos.farming.v1beta1.MsgRemovePlan")
	proto.RegisterType((*MsgRemovePlanResponse)(nil), "cosmos.farming.v1beta1.MsgRemovePlanResponse")
...
var fileDescriptor_a33d9a3ff13f514a = []byte{
	...
	,
}
...
func (c *msgClient) RemovePlan(ctx context.Context, in *MsgRemovePlan, opts ...grpc.CallOption) (*MsgRemovePlanResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/cosmos.farming.v1beta1.Msg/RemovePlan", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Msg_RemovePlan_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/cosmos.farming.v1beta1.Msg/RemovePlan",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func (m *MsgCreateRatioPlan) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.RewardDenoms) > 0 {
		for iNdEx := len(m.RewardDenoms) - 1; iNdEx >= 0; iNdEx-- {
			...
			i = encodeVarintTx(dAtA, i, uint64(len(m.RewardDenoms[iNdEx])))
			i--
			dAtA[i] = 0x3a
		}
	}
