...
type GenesisState struct {
	...
	TotalStakingRecords       []TotalStakingRecord       `protobuf:"bytes,8,rep,name=total_staking_records,json=totalStakingRecords,proto3" json:"total_staking_records" yaml:"total_staking_records"`
...
// TotalStakingRecord is used for import/export via genesis json.
type TotalStakingRecord struct {
	StakingCoinDenom string `protobuf:"bytes,1,opt,name=staking_coin_denom,json=stakingCoinDenom,proto3" json:"staking_coin_denom,omitempty" yaml:"staking_coin_denom"`
	...
	StakingReserveCoins github_com_cosmos_cosmos_sdk_types.Coins `protobuf:"bytes,9,rep,name=staking_reserve_coins,json=stakingReserveCoins,proto3,castrepeated=github.com/cosmos/cosmos-sdk/types.Coins" json:"staking_reserve_coins" yaml:"reward_pool_coins"`
}

func (m *TotalStakingRecord) Reset()         { *m = TotalStakingRecord{} }
func (m *TotalStakingRecord) String() string { return proto.CompactTextString(m) }
func (*TotalStakingRecord) ProtoMessage()    {}
func (*TotalStakingRecord) Descriptor() ([]byte, []int) {
	return fileDescriptor_c67612b66bcd2967, []int{4}
}
func (m *TotalStakingRecord) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *TotalStakingRecord) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_TotalStakingRecord.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *TotalStakingRecord) XXX_Merge(src proto.Message) {
	xxx_messageInfo_TotalStakingRecord.Merge(m, src)
}
func (m *TotalStakingRecord) XXX_Size() int {
	return m.Size()
}
func (m *TotalStakingRecord) XXX_DiscardUnknown() {
	xxx_messageInfo_TotalStakingRecord.DiscardUnknown(m)
}

var xxx_messageInfo_TotalStakingRecord proto.InternalMessageInfo
...
func init() {
	...
	proto.RegisterType((*TotalStakingRecord)(nil), "cosmos.farming.v1beta1.TotalStakingRecord")
...
var fileDescriptor_c67612b66bcd2967 = []byte{
	...
	,
}
...
func (m *GenesisState) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.TotalStakingRecords) > 0 {
		for iNdEx := len(m.TotalStakingRecords) - 1; iNdEx >= 0; iNdEx-- {
			{
				size, err := m.TotalStakingRecords[iNdEx].MarshalToSizedBuffer(dAtA[:i])
				if err != nil {
					return 0, err
				}
				i -= size
...
func (m *TotalStakingRecord) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *TotalStakingRecord) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *TotalStakingRecord) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *GenesisState) Size() (n int) {
	...
	if len(m.TotalStakingRecords) > 0 {
		for _, e := range m.TotalStakingRecords {
			l = e.Size()
			n += 1 + l + sovGenesis(uint64(l))
		}
	}
...
func (m *TotalStakingRecord) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *GenesisState) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 8:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field TotalStakingRecords", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.TotalStakingRecords = append(m.TotalStakingRecords, TotalStakingRecord{})
			if err := m.TotalStakingRecords[len(m.TotalStakingRecords)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 9:
...
func (m *TotalStakingRecord) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: TotalStakingRecord: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: TotalStakingRecord: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
