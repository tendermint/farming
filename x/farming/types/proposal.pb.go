...
type AddPlanRequest struct {
	...
	RewardDenoms []string `protobuf:"bytes,9,rep,name=reward_denoms,json=rewardDenoms,proto3" json:"reward_denoms,omitempty" yaml:"reward_denoms"`
}
...
func (m *AddPlanRequest) GetRewardDenoms() []string {
	if m != nil {
...
type ModifyPlanRequest struct {
	...
	// reward_denoms specifies the whitelist of reward coin denoms that this plan will distribute
	RewardDenoms []string `protobuf:"bytes,10,rep,name=reward_denoms,json=rewardDenoms,proto3" json:"reward_denoms,omitempty" yaml:"reward_denoms"`
}
...
func (m *ModifyPlanRequest) GetRewardDenoms() []string {
	if m != nil {
		return m.RewardDenoms
	}
	return nil
...
var fileDescriptor_4719b03c30c7910a = []byte{
	...
	,
}
...
func (m *AddPlanRequest) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.RewardDenoms) > 0 {
		for iNdEx := len(m.RewardDenoms) - 1; iNdEx >= 0; iNdEx-- {
			...
			i = encodeVarintProposal(dAtA, i, uint64(len(m.RewardDenoms[iNdEx])))
			i--
			dAtA[i] = 0x4a
		}
	}
